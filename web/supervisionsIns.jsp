...
<head>
    <meta charset="UTF-8">
    <title>Добавить режим надзора</title>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="page-header" style="text-align: center; margin-top: 5px">
                    <h3>Добавить режим надзора</h3>
                </div>
                <form action="/SupervisionServlet" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="nameMode" class="form-control"
                                   pattern="[A-Za-z-а-яА-ЯёЁ\s]{1,30}"id="nameMode"  title="Разрешены только буквы" value="${supervision.nameMode}"
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-8">
                            <input type="text"
                                   pattern="[A-Za-z-а-яА-ЯёЁ\s]{1,30}"id="resultSupervision"  required
                                   title="Разрешены только буквы" class="form-control" name="resultSupervision"
                                   value="${supervision.resultSupervision}"
                                   placeholder="Результат надзора" required="" maxlength="10"/>
                        </div>
                    </div>
